<div id="sidebar">
    ...
    <ul>
        ...
        @if($authUser?->user_role === 'Admin')
            ...
            <li><a href="{{ route('courses.index') }}"><i class="fas fa-user"></i> Subjects</a></li>
            <li><a href="{{ route('enrollments.index') }}"><i class="fas fa-user"></i> Enrollments</a></li>
            <li><a href="{{ route('marks.index') }}"><i class="fas fa-user"></i> Grades</a></li>
        ...
        @elseif($authUser?->user_role === 'Student')
            ...
            <li><a href="{{ route('student.marks') }}"><i class="fas fa-user"></i> Grades</a></li>
        @endif
    </ul>
    <div id="user-info">
